...
\begin{document}
    ...
    \subsection{Systems Administration Team}\label{subsec:the-systems-administration-team}
    This is the team dealing with practical problems, the systems administration team will be creating an on-premise
    VPS provider that can be leased to other clubs, faculty, member and individual students.\ CSSAC will also reserve a
    portion of the resources to deploy services for everyone in the university.
