...
\begin{document}
    ...
    \begin{enumerate}
        ...
        include services like providing cloud storage, git hosting, mail relay, etc.\ Initially, we might reserve all
        resources to deploy services that are available to everyone in the university.
    \end{enumerate}
